...
Under the current `v0.4.0` architecture, when an AI agent running in a headless MCP client (such as Claude Desktop or Cursor) requests a tool execution that requires manual confirmation:
