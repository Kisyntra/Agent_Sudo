...
This demo shows the validated `v0.2.0-beta` workflow: a critical shell action is blocked without approval, allowed once by scoped delegation, then denied after the token is exhausted.
